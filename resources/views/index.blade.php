...
<div class="wrapper">
  <header class="main-header">
    ...
    <a href="/dashboard" class="logo">
      ...
      <span class="logo-lg"><b>Aphrodite</b>Here!</span>
    </a>
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="/barang"><i class="fa fa-circle-o"></i> Data</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
